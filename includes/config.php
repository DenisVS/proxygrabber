...
$minimumOk = 100;	//больше какого порога рабочих ОК не грабить новые (величина списка, оперативность, нагрузка процессора)
...
$minTimeCheck = 200; // Минимальное время проверки, чтобы не чекать новые
